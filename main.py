...
class Config(object):
    ...
    AUTH_USERS = os.environ.get('AUTH_USERS', '7118905960,7097613157').split(',')
    for i in range(len(AUTH_USERS)):
        AUTH_USERS[i] = int(AUTH_USERS[i])

    GROUPS = os.environ.get('GROUPS', '-1002125995517').split(',')
    for i in range(len(GROUPS)):
        GROUPS[i] = int(GROUPS[i])

    LOG_CH = -1002125995517
...
class Store(object):
    ...
    ADDA_TOKEN = ""
    THUMB_URL = "https://telegra.ph/file/d856ca30ffe9d6f4d1436.jpg"
